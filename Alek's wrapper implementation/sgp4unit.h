...
*
*    current :
*				24 Jul 14 Alek Lidtke
*							changed header safeguards to #pragma once
...
// -------------------------- Conversion factors used here and elsewhere --------------------------
const double deg2rad = PI/180.0; // Conversion factor between degrees and radians. 0.0174532925199433
